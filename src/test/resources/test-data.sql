...
INSERT INTO asset_transaction (asset_id, position_direction, quantity, open_price, close_price, open_date, close_date, state)
VALUES
    -- AAPL (0 to 3 entries)
    (1, 'LONG', 10, 150.25, NULL, '2023-01-15 09:30:00', NULL, 'OPEN'),
    (1, 'SHORT', 5, 155.50, 157.75, '2023-02-10 10:15:00', '2023-02-10 14:30:00', 'CLOSED'),
    (1, 'LONG', 15, 160.00, NULL, '2023-03-05 08:45:00', NULL, 'OPEN'),

    -- MSFT (0 to 3 entries)
    (2, 'LONG', 8, 75.50, NULL, '2023-01-20 11:00:00', NULL, 'OPEN'),
    (2, 'SHORT', 4, 78.25, 76.00, '2023-02-15 09:45:00', '2023-02-15 14:15:00', 'CLOSED'),

    -- AMZN (0 to 3 entries)
    (3, 'LONG', 12, 30.75, NULL, '2023-01-25 10:30:00', NULL, 'OPEN'),
    (3, 'SHORT', 6, 33.00, 34.50, '2023-02-20 12:30:00', '2023-02-20 16:45:00', 'CLOSED'),

    -- GOOGL (0 to 3 entries)
    (4, 'LONG', 7, 1450.75, NULL, '2023-01-30 09:00:00', NULL, 'OPEN'),
    (4, 'SHORT', 3, 1475.25, 1468.50, '2023-02-25 10:45:00', '2023-02-25 15:30:00', 'CLOSED'),

    -- TSLA (0 to 3 entries)
    (5, 'LONG', 9, 650.50, NULL, '2023-02-05 13:15:00', NULL, 'OPEN'),
    (5, 'SHORT', 2, 655.00, 658.75, '2023-03-02 14:30:00', '2023-03-02 16:00:00', 'CLOSED'),

    -- FB (0 to 3 entries)
    (6, 'LONG', 5, 250.20, NULL, '2023-01-10 08:30:00', NULL, 'OPEN'),
    (6, 'SHORT', 3, 260.75, 255.50, '2023-02-15 11:45:00', '2023-02-15 14:30:00', 'CLOSED'),

    -- JNJ (0 to 3 entries)
    (7, 'LONG', 6, 140.50, NULL, '2023-02-20 09:15:00', NULL, 'OPEN'),
    (7, 'SHORT', 2, 145.25, 143.75, '2023-03-05 10:30:00', '2023-03-05 12:45:00', 'CLOSED'),

    -- DIS (0 to 3 entries)
    (8, 'LONG', 8, 160.75, NULL, '2023-03-10 08:00:00', NULL, 'OPEN'),
    (8, 'SHORT', 4, 165.00, 163.25, '2023-04-02 10:45:00', '2023-04-02 14:30:00', 'CLOSED'),

    -- NFLX (0 to 3 entries)
    (9, 'LONG', 10, 340.50, NULL, '2023-04-10 13:15:00', NULL, 'OPEN'),
    (9, 'SHORT', 6, 350.25, 348.75, '2023-05-05 14:30:00', '2023-05-05 16:00:00', 'CLOSED'),

    -- PG (0 to 3 entries)
    (10, 'LONG', 7, 120.25, NULL, '2023-05-15 09:30:00', NULL, 'OPEN'),
    (10, 'SHORT', 3, 125.50, 123.75, '2023-06-10 10:15:00', '2023-06-10 14:30:00', 'CLOSED');